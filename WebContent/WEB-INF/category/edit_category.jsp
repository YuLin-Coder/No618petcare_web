        ...
        <div class="form-box">
            <div class="row">
                ...
                <div class="form-group">
                            <label>种类名称：</label>
                            <input type="text" name="cname" id="cname" value="${category.cname }" placeholder="比如犬类" class="form-control">                          
                        ...
                        <div class="form-group">
                            <label>种类说明：</label>
                               <textarea type="text" name="note" id="note" rows="5" class="form-control">${category.note}</textarea>
