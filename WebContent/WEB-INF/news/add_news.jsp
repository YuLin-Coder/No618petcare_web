...
<main>
    <div class="main">
        ...
        <div class="form-box">
            <div class="row">
                <div class="col-5">
                    <form action="NewsServlet?action=add"  enctype="multipart/form-data"   method="post" > <!---->
                            <small   style="color:red">${msg}</small>
                            
                <div class="form-group">
                            <label>标题：</label>
                            <input type="text" name="title" id="title" value="" placeholder="请输入标题" class="form-control">                          
                   ...
                   <div class="form-group">
                     ...
                     <label>上传图片：</label>
                        ...
                        <div class="form-group">
                            <label>编辑者：</label>
                            <input type="text" name="editor" id="editor" value="${admin.nickname }" placeholder="请输入编辑者" class="form-control">                          
